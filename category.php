...
$catId = $path[count($path) - 2];
$brdId = $path[count($path) - 1];

$productList = $ProductModel->getProductInBrand($catId, $brdId);
...
<head>
    ...
    <title>Subas || Shop Left Sidebar</title>
    ...
    <script>
        function addcart() {
            var qlt = $('#french-hens').val();
            $("input[name='product_quanlity_quickview']").val(qlt);
        }
    </script>
</head>
                    ...
                    <div class="full-width-mega-dropdown">
                        <div class="row">
                            ...
                            <div class="col-md-2 col-sm-6 col-xs-12">
                                <div class="logo">
                                    <a href="/subas/index.php">
                                        <img src="/subas/parent/img/logo/logo.png" alt="main logo">
                                    </a>
                                </div>
                            </div>
                            <!-- primary-menu -->
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="breadcrumbs-inner">
                                <h1 class="breadcrumbs-title">Sản phẩm theo danh mục</h1>
                            ...
                            <div class="shop-content">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div role="tabpanel" class="tab-pane active" id="grid-view">
                                        <div class="row">
                                            <!-- product-item start -->
                                            <?php foreach ($productList as $proGridView) {?> <div
                                                class="col-md-4 col-sm-4 col-xs-12">
                                                <div class="product-item">
                                                    <div class="product-img">
                                                        <a
                                                            href="/<?php echo BASE_URL ?>/detail.php/<?php echo str_replace(' ', '-', strtolower(utf8convert($proGridView['product_name']))) . '-' . $proGridView['product_id'] ?>">
                                                            <img src="/<?php echo BASE_URL ?>/public/images/<?php echo $proGridView['product_image'] ?>"
                                                                alt="" />
                                                        </a>
                                                    </div>
                                                    ...
                                                    <div class="product-info">
                                                        <h6 class="product-title">
                                                            <a
                                                                href="/<?php echo BASE_URL ?>/detail.php/<?php echo str_replace(' ', '-', strtolower(utf8convert($proGridView['product_name']))) . '-' . $proGridView['product_id'] ?>">
                                                                <?php echo $proGridView['product_name'] ?>
                                                            </a>
                                                        </h6>
                                                        ...
                                                        <h3 class="pro-price">
                                                            <?php echo number_format($proGridView['product_price'], 2, ',', '.') ?>
                                                        </h3>
                                                        <ul class="action-button">
                                                            ...
                                                            <li>
                                                                <a href="#" data-toggle="modal"
                                                                    data-target="<?php echo '#' . $proGridView['product_id'] ?>"
                                                                    title="Quickview"><i
                                                            ...
                                                            <li>
                                                                <a 
                                                                 href="/<?php echo BASE_URL ?>/addcart.php?id=<?php echo $proGridView['product_id'] ?>"
                                    ...
                                    <div role="tabpanel" class="tab-pane" id="list-view">
                                        <div class="row">
                                            <?php foreach ($productList as $proGridView) {?>
                                            <!-- product-item start -->
                                            <div class="col-md-12">
                                                    ...
                                                    <div class="product-info">
                                                        <div class="clearfix">
                                                            <h6 class="product-title f-left">
                                                                <a
                                                                    href="/<?php echo BASE_URL ?>/detail.php/<?php echo str_replace(' ', '-', strtolower(utf8convert($proGridView['product_name']))) . '-' . $proGridView['product_id'] ?>"><?php echo $proGridView['product_name'] ?>
                                                                </a>
                                                            </h6>
                                                        ...
                                                        <p><?php echo mb_substr($proGridView['product_desc'], 0, 160) ?><a
                                                                href="/<?php echo BASE_URL ?>/detail.php/<?php echo str_replace(' ', '-', strtolower(utf8convert($proGridView['product_name']))) . '-' . $proGridView['product_id'] ?>">
                                                                ...</a></p>
                                                        <ul class="action-button">
                                                            <li>
                                                            ...
                                                            <li>
                                                                <a href="/<?php echo BASE_URL ?>/addcart.php?id=<?php echo $proGridView['product_id'] ?>"
                                                                    title="Thêm vào giỏ hàng"><i
                                                                        class="zmdi zmdi-shopping-cart-plus"></i></a>
                                                            </li>
                                                        </ul>
                        ...
                        <div class="col-md-3 col-md-pull-9 col-xs-12">
                            ...
                            <aside class="widget widget-categories box-shadow mb-30">
                                ...
                                <div id="cat-treeview" class="product-cat">
                                    <ul>
                                        <?php foreach ($catList as $catValue) {?>
                                        <li class="closed expandable"><a
                                                href="#"><?php echo $catValue['category_name'] ?></a>
                                            <ul>
                                                <?php
$brandList = $brandModel->getBrandInCategory($catValue['category_id'])[0];
    ...
    foreach ($brandId as $brandItem) {
        ...
        ?>
                                                <li><a
                                                        href="/<?php echo BASE_URL ?>/category.php/<?php echo str_replace(' ', '-', strtolower($catValue['category_name'] . '-' . $catValue['category_id'] . '-' . $brandItem)) ?>"><?php echo $brandValue['brand_name'] ?></a>
                                                </li>
                                                <?php }?>
                                            </ul>
                                        </li>
        ...
        <div id="quickview-wrapper">
            <?php foreach ($productList as $proQuick) {?>
            <!-- Modal -->

            <div class="modal fade" id="<?php echo $proQuick['product_id'] ?>" tabindex="-1" role="dialog"
                style="display: none;">
    ...
    width: 870px;
                            ...
                            <div class="modal-product clearfix">
                                <div class="product-images">
                                    <div class="main-image images">
                                        <img alt=""
                                            src="/<?php echo BASE_URL ?>/public/images/<?php echo $proQuick['product_image'] ?>">
                                    </div>
                                </div><!-- .product-images -->

                                <div class="product-info">
                                    <h1><?php echo $proQuick['product_name'] ?></h1>
                                    <div class="price-box-3">
                                        <div class="s-price-box">
                                            <span class="new-price"><?php echo $proQuick['product_price'] ?></span>

                                        </div>
                                    </div>
                                    <a href="/<?php echo BASE_URL ?>/detail.php/<?php echo str_replace(' ', '-', strtolower(utf8convert($proQuick['product_name']))) . '-' . $proQuick['product_id'] ?>"
                                        class="see-all">See all features</a>
                                    <div class="quick-add-to-cart">
                                        <form method="post" class="cart"
                                            action="/<?php echo BASE_URL ?>/addcart.php?id=<?php echo $proQuick['product_id'] ?>">
                                            <button class="single_add_to_cart_button" type="submit">Thêm vào giỏ
                                                hàng</button>
                                        </form>
                                    </div>
                                    <div class="quick-desc">
                                        <?php echo mb_substr($proQuick['product_desc'], 0, 120) . '...' ?>
                                    </div>
        ...
        <div class="style-customizer closed">
            <div class="buy-button">
                <a href="index.html" class="customizer-logo"><img
