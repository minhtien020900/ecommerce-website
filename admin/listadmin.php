...
$userList = $UserModel->getUserListPage($perPage, $page);
          ...
          <?php if ($_SESSION['user_role']==3) { ?>
            ...
            <li class="nav-item has-treeview menu-open">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="/<?php echo BASE_URL ?>/admin/listadmin.php" class="nav-link active">
...
if ($isDelete == true) {
  ...
  '<a href='.'listadmin.php'.'> Reload</a>'.'<br><small>Nếu thấy lỗi hãy reload lại</small>'
  ."</div>";
} else {
    echo "<div class ='alert alert-" . $active . "' role='alert'>" . $notification .
        "</div>";
        ...
        <table class="table table-bordered table-striped table-hover ">
          ...
          <?php if ($isData==true) {
            ...
            for ($i=0; $i <count($userList) ; $i++) { 
              if ($userList[$i]['user_role']==1||$userList[$i]['user_role']==3) {
                $i++;
              }
    ...
    ?>
            ...
            <th scope="row"><?php echo $userList[$i]['user_id']; ?></th>
              ...
              <td><a href="/<?php echo BASE_URL ?>/admin/addadmin?id=<?php echo $userList[$i]['user_id'] ?>"><i
                ...
                <td><form action="/<?php echo BASE_URL ?>/admin/listadmin.php" method="post"
