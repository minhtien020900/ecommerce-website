...
if (isset($_GET['keyword'])) {
  $searchPro=$_GET['keyword'];
  $productList = $ProductModel->search($searchPro); 
}
// $totalRow = $ProductModel->getTotalProductKeyword($searchPro);
// echo $totalRow;
      ...
      <section class="content">
        <div class="card-body">
          <div class="form-group">
            ...
            <!-- //  echo "<div class='row'>
            //     <div class='col-md-7'> 
            //       <p class='alert alert-success' ><b style='color:#343a40'>".$notification." Bạn cần phải tải lại trang để xem cập nhật</b></p>
            //     </div>
            //     <div class='col-md-5'>
            //         <button type='button' class='btn btn-danger' style='margin:7px 0' onclick='reload();'>Reload</button>
            //     </div>";
            // echo "<script>location.reload()</script>";
            // echo "<p class='alert alert-success'>".$notification."</p>";
            // $isDelete=false; -->
            <?php
      if ($isDelete == true) {
